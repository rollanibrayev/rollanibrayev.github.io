...
inputs[1 - 1].addEventListener('input', event => smallInput(event, 0))
inputs[2 - 1].addEventListener('input', event => smallInput(event, 1))
inputs[3 - 1].addEventListener('input', event => smallInput(event, 2))
inputs[4 - 1].addEventListener('input', event => smallInput(event, 3))
